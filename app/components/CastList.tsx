  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-imdb-dim leading-relaxed text-sm mt-3">
          {displayPlot}
        </p>
      ...
      <div>
        ...
        {cast.length > 0 ? (
          <div className="grid grid-cols-2 gap-2.5 mt-3">
            {cast.map((name, i) => {
              const hue =
                (name.charCodeAt(0) * 47 + (name.charCodeAt(1) || 0) * 13) %
                360;
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-xs text-imdb-text font-medium truncate leading-tight">
                      {name}
                    </p>
          ...
          <p className="text-imdb-muted text-sm mt-3">No cast info available</p>
        )}
      </div>
    </motion.div>
  );
...
function Label({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <p className="text-[10px] font-bold text-imdb-muted uppercase tracking-widest">
        {children}
      </p>
    </div>
  );
